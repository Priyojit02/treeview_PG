...
export default function App() {
  ...
  // --- Filters state: split month/year for end & comparison, plus companyCode & ledger
                ...
                <Stack direction={{ xs: "column", sm: "row" }} spacing={1} alignItems="center" sx={{ mb: 1 }}>
                  ...
                  <FormControl size="small" sx={{ minWidth: 160 }}>
                    ...
                    >
                      ...
                      <MenuItem value="OL">OL (NG Leading Ledger)</MenuItem>
                      <MenuItem value="AA">AA (Alt Ledger)</MenuItem>
                    </Select>
                  </FormControl>
